...
def validar_formulario_web_openai(
    web_content: dict,
    api_key: str,
    ...
    """
    Valida y clasifica un envío de formulario web usando OpenAI.
    ...
    # se deja pasar a OpenAI para evaluar con los demás datos (nombre, email, teléfono).
    ...
    prompt_sistema = (
        "Eres un clasificador de formularios web especializado en detección de spam.\n\n"
        "Tu tarea es:\n"
        ...
        f"{spam_utils._construir_contexto_ejemplos_spam(ejemplos_spam)}"
        f"{contexto_spam}"
    ...
    messages = [
        ...
        {"role": "user", "content": f"Analiza y clasifica este envío de formulario web:\n\n{contenido_str}"}
    ]
